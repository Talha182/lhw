...
class _ProgressStep extends StatelessWidget {
  ...
  Widget _stepContainer([Color? color]) => Container(
    ...
    decoration: BoxDecoration(
      color: color,
      borderRadius: BorderRadius.only(
        topLeft: _radiusTopLeft ? Radius.circular(8.0) : Radius.zero,
        topRight: _radiusTopRight ? Radius.circular(8.0) : Radius.zero,
        bottomLeft: _radiusBottomLeft ? Radius.circular(8.0) : Radius.zero,
        bottomRight: _radiusBottomRight ? Radius.circular(8.0) : Radius.zero,
      ),
    ),
  );
