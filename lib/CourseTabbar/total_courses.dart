...
class TotalCourses extends StatefulWidget {
  @override
  State<TotalCourses> createState() => _TotalCoursesState();
}

class _TotalCoursesState extends State<TotalCourses> {
  List<String> messages = [
    "نئی مہارت اور علم حاصل کرنے کے لیے تمام کورسز کو دیکھیں۔",
  ];
