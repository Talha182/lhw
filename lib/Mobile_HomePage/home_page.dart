...
class _HomePageState extends State<HomePage> {
                      ...
                      child: FadeInAnimation(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            buildMaterial(screenWidth),
                            const SizedBox(
                              height: 30,
                            ),
                            buildMaterial2(screenWidth),
                          ],
                        ),
                      ),
                    ),
  ...
  Material buildMaterial2(double screenWidth) {
    return Material(
  ...
  Material buildMaterial(double screenWidth) {
    return Material(
      elevation: 1, // Set your desired elevation value here
      borderRadius: BorderRadius.circular(10),
      child: Container(
                ...
                child: Row(
                  children: [
                    GradientCircle(
                      ...
                      imagePath: 'assets/images/dots.svg',
                      imageWidth: 22,
                      imageHeight: 22, // Replace with your image path
                    ),
                    SizedBox(
                      width: 10,
                    ),
                    ...
                    GradientCircle(
                      ...
                      imagePath: 'assets/images/badge.svg',
                      imageWidth: 24,
                      imageHeight: 24, // Replace with your image path
                    ),
                    SizedBox(
                      width: 10,
                    ),
