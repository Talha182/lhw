...
class _ModuleScreenTestState extends State<ModuleScreenTest> {
  ...
  Widget build(BuildContext context) {
    ...
    final progressValue = course.progress; // Assume this is a value between 0.0 and 1.0
      ...
      body: Directionality(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(top: 12.0, right: 25.0,bottom: 12.0),
              child: Row(
                children: [
                  ...rowPadded([
            ...
            Expanded(
                child: ListView.builder(
                  itemCount: course.modules.length, // Use modules.length from the course
                  itemBuilder: (context, index) {
                    final module = course.modules[index];
                    return Module_Card(
                      progressValue: module.progressValue,
                      showProgressBar: module.isStart, // Assuming this decides if the progress bar should be shown
