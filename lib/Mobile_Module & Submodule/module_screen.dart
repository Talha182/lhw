          ...
          'onTap': () {
            Get.to(
                () => JourneyMapScreen2(
                      ...
                      titleAlignments: ['left', 'right', 'left', 'left'],
                    ),
                transition: Transition.fade,
                duration: const Duration(milliseconds: 400));
          },
...

        {
          ...
          'onTap': () {
            Get.to(
                  ...
                  navigateActions: [
                        () => Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const Submodule1())), () => Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const Submodule1())),
                        () => Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const Submodule3())),
                  ],
                  numberOfQuizzes: const [1, 1,1],
                  titleAlignments: ['left','right', 'left'],
                ),
                transition: Transition.fade,
                duration: const Duration(milliseconds: 400));
          },
