...
class RightStartingProgressBar extends StatefulWidget {
  final double width;
  final double height;
  final double targetProgress; // Renamed to "targetProgress" to indicate final value after animation
  ...
  @override
  _RightStartingProgressBarState createState() => _RightStartingProgressBarState();
}

class _RightStartingProgressBarState extends State<RightStartingProgressBar> with SingleTickerProviderStateMixin {
  late AnimationController _controller;
  ...
  void initState() {
    ...
    _animation = Tween<double>(begin: 0, end: widget.targetProgress).animate(_controller)
      ..addListener(() {
        setState(() {}); // Trigger a rebuild whenever the animation value changes
      });
        ...
        children: [
          Positioned(
            ...
            child: Container(
              ...
              width: widget.width * _animation.value, // Use the animation value here
              decoration: BoxDecoration(
                gradient: LinearGradient(colors: [Color(0xffF4D6A9), Color(0xffEAAF58)]),
                borderRadius: BorderRadius.circular(widget.strokeWidth / 2),
              ),
            ),
          ),
