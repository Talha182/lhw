...
class _AchievementsState extends State<Achievements>
  ...
  bool _innerScrollEnabled = true;

  @override
  void initState() {
    super.initState();
    _innerScrollController.addListener(_updateScrollability);
          ...
          if (notification.depth == 1 &&
            ...
            if (notification.overscroll < 0 &&
              ...
              _outerScrollController.jumpTo(
                  _outerScrollController.offset + notification.overscroll);
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const Text(
                                          "کسی بھی سبق میں اپنے نمبر دہرائی کے بعد بہتر کرنے پر آپ کو یہ تمغہ انعام کیا جائے گا۔",
                                          style: TextStyle(
                                              fontFamily: "UrduType",
                                              color: Color(0xff8B9DA0)),
                                        ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const Text(
                                          " سوالات پوچھیں اور یہ تمغہ حاصل کریں۔",
                                          style: TextStyle(
                                              fontFamily: "UrduType",
                                              color: Color(0xff8B9DA0)),
                                        ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const Text(
                                          " یہ تمغہ دن میں کم از کم ایک دفعہ ایپ استعمال کرنے پر ملتا ہے۔",
                                          style: TextStyle(
                                              fontFamily: "UrduType",
                                              color: Color(0xff8B9DA0)),
                                        ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        const Text(
                                          "آپ کی رائے ہم سب کے لیے بہت مفید ہے اور ہم شکر گزار ہیں۔ یہ\n تمغہ آپ کی اہم رائے کے لیے ہے۔",
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 5,),
                                        const Text(
                                          "کامیابیاں اور خوشیاں ہمیشہ بانٹنی چاہئیں۔ سوشل میڈیا پر شیئر کریں\n اور جیتیں۔",
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                              fontFamily: "UrduType",
                                              color: Color(0xff8B9DA0)),
