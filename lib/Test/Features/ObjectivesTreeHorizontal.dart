...
class ObjectivesTreeHorizontal extends StatefulWidget {
  ObjectivesTreeHorizontal({Key? key}) : super(key: key);

  @override
  State<ObjectivesTreeHorizontal> createState() =>
      _ObjectivesTreeHorizontalState();
}

class _ObjectivesTreeHorizontalState extends State<ObjectivesTreeHorizontal> {
  @override
  void initState() {
      ...
      body: Stack(
        children: [
          ...
          ...iconsData.map((iconData) => Positioned(
                left: iconData['position'] == Alignment.bottomLeft ||
                        iconData['position'] == Alignment.topLeft
                    ? iconData['offset'].dx
                    : null,
                right: iconData['position'] == Alignment.bottomRight ||
                        iconData['position'] == Alignment.topRight
                    ? -iconData['offset'].dx
                    : null,
                top: iconData['position'] == Alignment.topRight ||
                        iconData['position'] == Alignment.topLeft
                    ? iconData['offset'].dy
                    : null,
                bottom: iconData['position'] == Alignment.bottomRight ||
                        iconData['position'] == Alignment.bottomLeft
                    ? -iconData['offset'].dy
                    : null,
                child: IconButton(
