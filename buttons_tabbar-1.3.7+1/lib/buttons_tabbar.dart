...
class _ButtonsTabBarState extends State<ButtonsTabBar>
  ...
  late List<Color> _tabBackgroundColors;  // Add this
  ...
  void initState() {
    ...
    super.initState();
    _tabBackgroundColors = List.generate(widget.tabs.length,
            (index) {
    ...
    return Padding(
        ...
        child: Container(
            decoration: BoxDecoration(
              color: _tabBackgroundColors[index],  // Use the color here
              borderRadius: BorderRadius.circular(20)
            ),
        child: Padding( // Wrap the TextButton in another Padding
        padding: EdgeInsets.only(bottom: 2), // Padding at the bottom
    child: TextButton(
        onPressed: () {
