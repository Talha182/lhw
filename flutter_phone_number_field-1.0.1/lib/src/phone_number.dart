...
class PhoneNumber {
  ...
  static String getNumber(String completeNumber) {
    final contry = PhoneNumber.getCountry(completeNumber);
    if (completeNumber.startsWith('+')) {
      completeNumber = completeNumber.replaceFirst(
          RegExp("^\\+${contry.fullCountryCode}"), "");
    } else {
      completeNumber =
          completeNumber.replaceFirst(RegExp("^${contry.fullCountryCode}"), "");
    }
