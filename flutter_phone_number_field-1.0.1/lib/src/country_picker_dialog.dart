...
class PickerDialogStyle {
  ...
  final TextStyle? countryFlagStyle;

  final double? webCountryIconWidth;
                    ...
                    ListTile(
                      leading: kIsWeb
                          ? Image.asset(
                              ...
                              width: widget.style!.webCountryIconWidth?? 32,
                            )
                          : Text(
                              _filteredCountries[index].flag,
                              style: widget.style!.countryFlagStyle?? const TextStyle(fontSize: 18),
                            ),
